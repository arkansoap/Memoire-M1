...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{KablesPerf}\NormalTok{(Predict2, datas}\SpecialCharTok{$}\NormalTok{test, }\StringTok{"popularity"}\NormalTok{)[[}\DecValTok{2}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{AllRoc}\NormalTok{(Predictions, datas}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{popularity)}
\FunctionTok{AllRoc}\NormalTok{(PredRec1, datRecid}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{is\_violent\_recid)}
\FunctionTok{AllRoc}\NormalTok{(PredCredit, creditcard}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{Class)}
\FunctionTok{AllRoc}\NormalTok{(PredHacked, datHacked}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{MULTIPLE\_OFFENSE)}
\end{Highlighting}
\end{Shaded}
