...
We can decide to give some weights to the data class in order to give more importance (more weight) to the positive class. Link with cost / benefits. 
